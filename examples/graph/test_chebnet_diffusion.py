...
parser.add_argument('--ptb_rate', type=float, default=0.05,  help='perturbation rate:0.05, 0.1, 0.15, 0.2, 0.25')
...
data1 = Dpr2Pyg(data)
cheby.fit(data1, verbose=True) # train with earlystopping
cheby.test()
...
gdc = T.GDC(self_loop_weight=1, normalization_in='sym',
            ...
            diffusion_kwargs=dict(method='ppr', alpha=0.05, t=8),
            sparsification_kwargs=dict(method='topk', k=128,
                                       dim=0), exact=True)
data2 = gdc(data2)

cheby.fit1(data2, verbose=True) # train with earlystopping
cheby.test()


# load pre-attacked graph by Zugner: https://github.com/danielzuegner/gnn-meta-attack
print('==================')
print('=== load graph perturbed by metattack (under seed 15) ===')
print('== ptb_rate: ',args.ptb_rate,' ==')
